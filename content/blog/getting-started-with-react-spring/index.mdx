...
import TranslateHorizontalWithColorChange from './components/TranslateHorizontalWithColorChange.jsx';
import Translate from './components/Translate.jsx';
import BarGraph from './components/BarGraph.jsx';
import StaggeredBars from './components/StaggeredBars.jsx';
import DisappearingComponent from './components/DisappearingComponent.jsx';
import TranslateStaggeredBars from './components/TranslateStaggeredBars.jsx';

<TranslateHorizontalWithColorChange>This is animated with react-spring</TranslateHorizontalWithColorChange>

As a front end developer, you will inevitably run into animations and transitions. If you're in the React ecosystem and your application has many complex animations, [react-spring](https://www.react-spring.io/) is a great library to helps you build your animations. In this post we will see how to get started with some simple examples.
...
In essence, animations in react-spring don't run based off time, they run based off physical properties that are configured into animations and the duration of the animation is just a result of these physical properties. If you'd like to use time based animations, react-spring has an escape hatch for you to do so. Checkout the [common API section](https://www.react-spring.io/docs/hooks/api)
...
<Translate>Translate me...Weee!</Translate>
