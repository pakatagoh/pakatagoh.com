...
_Last updated: 28 Aug 2022_

As a front end developer, you will inevitably run into animations and transitions. If you're in the React ecosystem and your application has many complex animations, [react-spring](https://www.react-spring.io/) is a great library that helps to build your animations. In this post we will see how to get started with some simple examples.
...
> **UPDATE**: The demo has been removed as it is causing an error on the page
