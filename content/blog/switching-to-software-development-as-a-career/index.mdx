...
description: 'Making a career switch is no easy decision and there are many factors at play. I talk about the reasons that made me make the jump into software development and how I prepared.'
...
In this post, I try my best to distill my personal reasons for the switch and how I prepared for it. I don't elaborate on how to stay motivated when learning to code by yourself. I think that's best left to a separate post.
...
After a couple of months of intensive research, I decided that I wanted to become a web/software developer. Who knew that would be the case when I started working on IoT projects. At the same time, I had no passion for the industry I was in and I didn't have much motivation to sell the hardware or to do sales in general.
...
If you're lazy to go through JDs, then [The Web Developer Roadmap](https://github.com/kamranahmedse/developer-roadmap) and [freeCodeCamp](https://www.freecodecamp.org) are definitely top resources to help with your learning curriculum.
...
- If you're contemplating a switch in careers, do your research and talk to people about the industry. Know what you're getting yourself into.
- Make a plan and have a deadline. This should all be done before you leave your job.

I think it's also important to mention that even though making a career switch is a serious choice, I think it's just as important to enjoy the experience and have fun, especially during the research phase.
