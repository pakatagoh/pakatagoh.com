...
Source: [https://eslint.org/docs/about](https://eslint.org/docs/about)
...
<Image src={eslintPrettierError} alt="ESLint error" layout="constrained" />
...
<Image src={eslintFix} alt="ESLint fix" layout="constrained" />
