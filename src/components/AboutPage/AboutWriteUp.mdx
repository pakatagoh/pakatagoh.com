...
In July 2018, I decided to leave my job as a technical sales engineer in the industrial sector to pursue software development as a career. As I was learning, I completed the [#100DaysOfCode](https://www.100daysofcode.com) challenge and managed to secure an internship as a junior developer. In Feb 2019, I joined a bootcamp conducted by [ThoughtWorks](https://www.thoughtworks.com/) (Singapore).
